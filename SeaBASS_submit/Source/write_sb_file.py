...
def data_table_hplc(amt):
   ...
   # bottle = amt['hplc_bottle'].to_pandas()
    ...
    mg_DVP = amt['hplc_Mg_DVP'].to_pandas()
...
if __name__ == '__main__':
        ...
        # nc file #
        finalnc = '/users/rsg/tjor/scratch_network/AMT_underway/AMT25/Processed/UWay/Step3/amt25_final_with_debiased_chl.nc' # hardcoded
        ...
        # document files
        fn_docs_acs = 'checklist_acs_particulate_inline_AMT25.rtf,checklist_acs_ag_cg_AMT25.rtf,AMT25_ACS_inline_ProcessingReport.docx' # hardcoded
